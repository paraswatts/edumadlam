    ...
    return (
        ...
        <View style={{ position: "absolute", flex: 1, left: 0, right: 0, bottom: 0, top: 0, alignItems: 'center', justifyContent: 'center', borderWidth: 5, zIndex: 9999999, }}>
            ...
            <View style={{ borderRadius: _scaleText(10).fontSize, margin: _scaleText(5).fontSize, backgroundColor: 'white', alignSelf: 'center', }}>
                ...
                <View style={{ borderTopWidth: 1, height: _scaleText(10).fontSize, borderColor: '#d2d2d2', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 10 }}>
