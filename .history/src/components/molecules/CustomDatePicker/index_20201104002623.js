...
const CustomDatePicker = ({
    ...
    return (
        // Platform.OS === 'ios' ?
        <View style={{ backgroundColor: 'rgba(0,0,0,0.9)', position: "absolute", flex: 1, left: 0, right: 0, bottom: 0, top: 0, alignItems: 'center', justifyContent: 'center', borderWidth: 0, zIndex: 9999999, }}>
