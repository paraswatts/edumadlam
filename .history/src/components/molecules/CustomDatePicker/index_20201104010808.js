...
const CustomDatePicker = ({
    ...
    return (
        // Platform.OS === 'ios' ?
        <View style={{ backgroundColor: 'rgba(0,0,0,0.5)', position: "absolute", flex: 1, left: 0, right: 0, bottom: 0, top: 0, alignItems: 'center', justifyContent: 'center', borderWidth: 0, zIndex: 9999999, }}>

            <View style={{ width: '90%', borderRadius: _scaleText(20).fontSize, backgroundColor: COLORS.GREY.LIGHTER, alignItems: 'center', justifyContent: 'center' }}>
