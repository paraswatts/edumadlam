...
const CustomMCQModal = ({
    ...
    return (
        <View style={[TEXT_STYLES.FLEX, { borderWidth: 5 }]}>
            ...
            />
            <View blurRadius={1} style={{ borderWidth: 2, borderColor: 'red', backgroundColor: 'rgba(255,255,255,0.9)', flex: 1, position: 'absolute', bottom: 0, right: 0, top: 0, left: 0, zIndex: 9999999 }}></View>
