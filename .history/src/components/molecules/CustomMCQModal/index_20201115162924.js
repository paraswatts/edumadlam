...
const CustomMCQModal = ({
    ...
    const [answeraList, updateAnswersList] = useState([])
    useEffect(() => {
        if (resetTimer) {
            updateOption(null)
            setSeconds(testTime)
    ...
    const onPressOption = (option, questionIndex, _id) => {
        ...
        updateAnswersList(answeraList => answeraList.push({ _id: _id, selectedOption: option }))
    ...
    const renderOption = (buttonOption, index, buttonStyles, _id) => {
        return (<CustomButton
                    ...
                    <View style={styles.innerContainer}>
                        ...
                        <View style={styles.optionsContainer}>
                            ...
                            <View style={{ borderWidth: 0, }}>
                                {renderOption(_opt1, index, [styles.optionButton, _id])}
                                {renderOption(_opt2, index, [styles.optionButton, styles.buttonTop, _id])}
                                {renderOption(_opt3, index, [styles.optionButton, styles.buttonTop, _id])}
                                {renderOption(_opt4, index, [styles.optionButton, styles.buttonTop, _id])}
                            </View>
                        </View>
                    </View>
                </ScrollView >
