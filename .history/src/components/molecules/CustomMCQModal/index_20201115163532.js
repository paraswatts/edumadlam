                    ...
                    <View style={styles.innerContainer}>
                        ...
                        <View style={styles.optionsContainer}>
                            ...
                            <View style={{ borderWidth: 0, }}>
                                {renderOption(_opt1, index, [styles.optionButton], _id, '_opt1')}
                                {renderOption(_opt2, index, [styles.optionButton, styles.buttonTop], _id, '_opt2')}
                                {renderOption(_opt3, index, [styles.optionButton, styles.buttonTop], _id, '_opt3')}
                                {renderOption(_opt4, index, [styles.optionButton, styles.buttonTop], _id, '_opt4')}
                            </View>
                        </View>
                    </View>
                </ScrollView >
