    ...
    const onPressOption = (option, questionIndex, _id, _quest) => {
        if (questionIndex === questionsObj.length - 1 && questionsObj.length > 1) {
            ...
            if (optionIndex === -1) {
                ...
                updateAnswersListObj(answersList => [...answersList, { qId: _id, answer: option, _quest: _quest }])
            }
            else {
                ...
                updateAnswersListObj(answersList.map((o) => {
                    if (o._id === _id) return { qId: o._id, answer: option, _quest: _quest }
                    return o;
                }))
