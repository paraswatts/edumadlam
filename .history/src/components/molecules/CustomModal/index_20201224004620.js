            ...
            >
                ...
                <View style={{ flex: 1 }}>
                    <View style={{ alignItems: 'center' }}>
                        ...
                        <View style={{ flexDirection: 'row' }}><MaterialCommunityIcons name={'circle-double'}
                            color={'red'} size={20} /><View><Text style={{ minWidth: 100 }}>{TEXT_CONST.SCORE} </Text><Text>:</Text><Text>{resultObj.score}</Text></View></View>
