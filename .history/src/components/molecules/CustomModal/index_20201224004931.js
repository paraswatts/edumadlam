            ...
            >
                ...
                <View style={{ flex: 1 }}>
                    <View style={{ alignItems: 'center' }}>
                        ...
                        <View style={{ flexDirection: 'row', borderTopWidth: 1, width: '100%', }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}><MaterialCommunityIcons name={'circle-double'}
                                color={'red'} size={20} /><View style={{ marginRight: _scaleText(20).fontSize }}><Text style={{ minWidth: 100 }}>{TEXT_CONST.SCORE} </Text><Text>{resultObj.score}</Text></View></View>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}><MaterialCommunityIcons name={'circle-double'}
                                color={'red'} size={20} /><View style={{ marginRight: _scaleText(20).fontSize }}><Text style={{ minWidth: 100 }}>{TEXT_CONST.CORRECT} </Text><Text>{resultObj.correct}</Text></View></View>
                        </View>
