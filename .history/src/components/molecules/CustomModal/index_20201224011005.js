...
const CustomModal = ({
    ...
    const showShareModal = () => {
        ...
        const shareOptions = {
            ...
            failOnCancel: false,
            urls: [appUrl],
            message: 'Hey! I secured Rank ' + resultObj.grade + ' while attempting Daily MCQs Test  \n  Download the EduMandala for latest Current Affairs, Articles, MCQs and Study Materials!'
        };
