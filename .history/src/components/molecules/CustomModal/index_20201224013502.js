            ...
            >
                ...
                <View style={{ flex: 1 }}>
                    <View style={{ alignItems: 'center' }}>
                        ...
                        {resultObj.grade ? <Text style={{ marginVertical: _scaleText(10).fontSize }}>{'Your grade is ' + resultObj.grade}</Text> : <Text style={{ marginVertical: _scaleText(10).fontSize }}>{''}</Text>}
