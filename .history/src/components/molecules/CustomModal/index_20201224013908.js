        ...
        return (
            <View onPress={() => {
                ...
                <View style={{ borderWidth: 0 }}>
                    <View>
                        <HTMLView addLineBreaks={true} style={[{ width: '90%', }, styles]} value={_quest.replace(/(\r\n|\n|\r)/gm, "")} />
                        <View>
                    ...
                    <View style={{ alignItems: 'center' }}>
                        ...
                        <View style={{ flexDirection: 'row', borderTopWidth: 0.5, width: '100%', padding: _scaleText(10).fontSize }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1, justifyContent: 'center' }}><MaterialCommunityIcons name={'circle-double'}
                                color={'red'} size={20} /><View style={{ marginLeft: _scaleText(20).fontSize, color: COLORS.BLUE_FONT }}><Text style={{ minWidth: 100, color: COLORS.BLUE_FONT }}>{TEXT_CONST.SCORE} </Text><Text>{resultObj.score}</Text></View></View>
                            <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1, justifyContent: 'center' }}><MaterialCommunityIcons name={'checkbox-marked-circle'}
                                color={COLORS.GREEN} size={20} /><View style={{ marginLeft: _scaleText(20).fontSize }}><Text style={{ minWidth: 100, color: COLORS.BLUE_FONT }}>{TEXT_CONST.CORRECT} </Text><Text>{resultObj.correct}</Text></View></View>
                        </View>
                        <View style={{ flexDirection: 'row', borderTopWidth: 0.5, width: '100%', padding: _scaleText(10).fontSize }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1, justifyContent: 'center' }}><MaterialCommunityIcons name={'close-circle-outline'}
                                color={'red'} size={20} /><View style={{ marginLeft: _scaleText(20).fontSize }}><Text style={{ minWidth: 100, color: COLORS.BLUE_FONT }}>{TEXT_CONST.WRONG} </Text><Text>{resultObj.wrong}</Text></View></View>
                            <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1, justifyContent: 'center' }}><MaterialCommunityIcons name={'checkbox-blank-circle'}
                                color={'#c2c2c2'} size={20} /><View style={{ marginLeft: _scaleText(20).fontSize }}><Text style={{ minWidth: 100, color: COLORS.BLUE_FONT }}>{TEXT_CONST.LEFT} </Text><Text>{resultObj.left}</Text></View></View>
                        </View>
                        <View style={{ flexDirection: 'row', borderTopWidth: 0.5, width: '100%', padding: _scaleText(10).fontSize }}>
