...
const CustomModal = ({
    ...
    const renderQuestionitem = ({ item, index }) => {
        ...
        return (
            <TouchableOpacity onPress={() => goToQuestion(index)} style={{ flexDirection: 'row', marginVertical: _scaleText(5).fontSize, marginHorizontal: _scaleText(10).fontSize, borderWidth: _scaleText(0.5).fontSize, padding: _scaleText(5).fontSize, borderRadius: _scaleText(5).fontSize }}>
