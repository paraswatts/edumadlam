    ...
    return (
        <View
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                <TouchableOpacity onPress={() => navigation.navigate(ROUTES.TEST.TEST_DETAIL, { _id: _id, _webPage: _webPage, _heading: _name })} style={{ flexDirection: 'row', alignSelf: 'flex-end', alignItems: 'center' }}>
