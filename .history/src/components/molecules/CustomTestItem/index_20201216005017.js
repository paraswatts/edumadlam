        ...
        <View
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                ...
                {!purchased && parseInt(_price) &&
                    <TouchableOpacity onPress={() => navigation.navigate(ROUTES.TEST.TEST_DETAIL, { _webPage: _webPage, _heading: _name })} style={{ flexDirection: 'row', alignSelf: 'flex-end', alignItems: 'center' }}>
