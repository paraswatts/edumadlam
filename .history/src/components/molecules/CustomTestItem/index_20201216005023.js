...
const CustomTestItem = ({ _id, _name, _price, _timestamp, _startDate, _endDate, _timetable, navigation, purchased, _webPage }) => {
    return (
        <View
            style={{
                shadowColor: '#b2b2b2',
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                ...
                {!purchased && parseInt(_price) &&
                    <TouchableOpacity onPress={() => navigation.navigate(ROUTES.TEST.PAYMENT_SCREEN, { _webPage: _webPage, _heading: _name })} style={{ flexDirection: 'row', alignSelf: 'flex-end', alignItems: 'center' }}>
