...
const CustomTestItem = ({ clickable, fetchPaymentPage, _id, _name, _price, _timestamp, _startDate, _endDate, _timetable, navigation, purchased, _webPage }) => {
    ...
    return (
        !clickable ? <View
            ...
            onPress={() => navigation.navigate(ROUTES.TEST.PURCHASED_TESTS, { _webPage: _webPage, _heading: _name })}
            style={{
                shadowColor: '#b2b2b2',
                shadowOffset: { width: 0, height: 1 },
                shadowOpacity: 0.8,
