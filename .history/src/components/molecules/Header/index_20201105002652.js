...
const CustomHeader = ({
    ...
    return (
        <View style={[styles.container, container]}>
            ...
            {!!left && left}
            <Text numberOfLines={1} style={[styles.rightTitle, titleStyle]}>{title}</Text>
            {currentStream && showFilter && <Text style={[styles.rightTitle, { textAlign: 'right' }]}>{currentStream}</Text>}
