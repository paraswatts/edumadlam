    ...
    return (
        ...
        >
            ...
            { loading ? <ActivityIndicator size={'large'} color={COLORS.GREY._2} />
                : <View><CustomMCQModal resetTimer={resetTimer} questionsObj={data} />  {showDate && <CustomDatePicker
                    selectedDate={selectedDate}
                    closeDatePicker={() => updateShowDate(false)} selectDate={selectDate} doneClick={submitDateChange} />}</View>}
