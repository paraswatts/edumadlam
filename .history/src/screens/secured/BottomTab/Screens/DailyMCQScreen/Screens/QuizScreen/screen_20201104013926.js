...
const QuizScreen = ({
    ...
    const [headerDate, updateHeaderDate] = useState(moment(new Date()).format("DD-MM-yyyy"))
    ...
    return (
        ...
        >
            ...
            { loading ? <ActivityIndicator size={'large'} color={COLORS.GREY._2} />
                : <CustomMCQModal testStarted={testStarted} resetTimer={resetTimer} questionsObj={data} />}
            {showDate &&
                <CustomDatePicker
