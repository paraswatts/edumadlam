    ...
    return (
        ...
        >
            ...
            { loading && !exiting ? <ActivityIndicator size={'large'} color={COLORS.GREY._2} />
                :
                data && data.length ?
                    <CustomMCQModal date={moment(selectedDate).format("DD MMMM yyyy")} name={"MCQ"} ref={childRef} submitTest={submitTest} updateAnswerList={updateAnswerList} testStarted={testStarted} resetTimer={resetTimer} questionsObj={data} />
