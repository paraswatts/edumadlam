    ...
    return (
        ...
        >
            ...
            <View style={{ height: width * 3 / 4, borderWidth: 1, margin: _scaleText(10).fontSize }}>
                ...
                <CustomButton label={TEXT_CONST.START_DAILY_QUIZ} labelSize={_scaleText(12).fontSize} labelStyle={{ textAlign: 'center' }} container={{ alignItems: 'center', justifyContent: 'center' }}></CustomButton>
