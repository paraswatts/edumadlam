    ...
    return (
        ...
        >
            ...
            <View style={{ height: width * 3 / 4, borderWidth: 1, margin: _scaleText(10).fontSize }}>
                ...
                <CustomButton label={TEXT_CONST.START_DAILY_QUIZ} labelSize={_scaleText(12).fontSize} labelStyle={{ textAlign: 'center', color: COLORS.WHITE }} container={{ alignItems: 'center', justifyContent: 'center', backgroundColor: COLORS.PRIMARY.YELLOW, borderTopLeftRadius: 0, borderTopRightRadius: 0, borderWidth: 0, height: _scaleText(50).fontSize, borderBottomLeftRadius: _scaleText(20).fontSize, borderBottomRightRadius: _scaleText(20).fontSize }}></CustomButton>
