...
export default StyleSheet.create({
    ...
    mcqButton: { alignItems: 'center', justifyContent: 'center', backgroundColor: COLORS.PRIMARY.YELLOW, borderTopLeftRadius: 0, borderTopRightRadius: 0, borderWidth: 0, height: _scaleText(50).fontSize, borderBottomLeftRadius: _scaleText(20).fontSize, borderBottomRightRadius: _scaleText(20).fontSize }
});