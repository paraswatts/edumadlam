...
const NewsSubCategory = ({
    ...
    return (
        <ScreenHOC
            ...
            headerTitle={'News Sub Categories'}
            showHeader
            showBackIcon
            ...
            <FlatList
                ...
                renderItem={({ item, index }) => {
                    ...
                    return (<TouchableOpacity
                        onPress={() => navigation.navigate(ROUTES.NEWS.DETAIL, { _id: _id })}
                        style={{
                            shadowColor: '#b2b2b2',
                        ...
                        <FastImage
                            ...
                            source={{ uri: _imgUrl }}
                        />
                        <Text style={{ fontWeight: '500', fontSize: 14, marginTop: 10, marginBottom: 10 }}>{_heading}</Text>
