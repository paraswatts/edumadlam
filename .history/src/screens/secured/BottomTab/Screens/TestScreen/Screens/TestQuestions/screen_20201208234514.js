                ...
                >
                    {resultObj ?
                        <View>
                            ...
                            <View style={{ flexDirection: 'row' }}><Text>Correct :</Text><Text>{resultObj.correct}</Text></View>
                            <View style={{ flexDirection: 'row' }}><Text>Wrong :</Text><Text>{resultObj.wrong}</Text></View>
                            <View style={{ flexDirection: 'row' }}><Text>Left :</Text><Text>{resultObj.left}</Text></View>
