    ...
    return (
        ...
        >
            ...
            {!!testSubmitSuccess && !exiting &&
                ...
                >
                    <Text style={{ marginBottom: 10 }}>{TEXT_CONST.TEST_SUBMITTED}</Text>

                    {resultObj ?
                        <View>
                            <View style={{ flexDirection: 'row' }}><Text style={{ minWidth: 100 }}>Score :</Text><Text>{resultObj.score}</Text></View>
                            <View style={{ flexDirection: 'row' }}><Text style={{ minWidth: 100 }}>Correct :</Text><Text>{resultObj.correct}</Text></View>
                            <View style={{ flexDirection: 'row' }}><Text style={{ minWidth: 100 }}>Wrong :</Text><Text>{resultObj.wrong}</Text></View>
                            <View style={{ flexDirection: 'row' }}><Text style={{ minWidth: 100 }}>Left :</Text><Text>{resultObj.left}</Text></View>
                            {!resultObj.pdf ? <View style={{ flexDirection: 'row' }}><Text style={{ minWidth: 100 }}>Result PDF :</Text><Text style={{ color: 'blue' }}>Download PDF</Text></View> : null}
