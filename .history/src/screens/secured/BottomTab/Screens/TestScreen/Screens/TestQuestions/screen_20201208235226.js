        ...
        >
            ...
            {!!testSubmitSuccess && !exiting &&
                ...
                >
                    ...
                    {resultObj ?
                        <View>
                            <View style={{ flexDirection: 'row' }}><Text style={{ minWidth: 100 }}>Score </Text><Text>:</Text><Text>{resultObj.score}</Text></View>
                            <View style={{ flexDirection: 'row' }}><Text style={{ minWidth: 100 }}>Correct </Text><Text>:</Text><Text>{resultObj.correct}</Text></View>
                            <View style={{ flexDirection: 'row' }}><Text style={{ minWidth: 100 }}>Wrong </Text><Text>:</Text><Text>{resultObj.wrong}</Text></View>
                            <View style={{ flexDirection: 'row' }}><Text style={{ minWidth: 100 }}>Left </Text><Text>:</Text><Text>{resultObj.left}</Text></View>
                            {resultObj.pdf ? <View style={{ flexDirection: 'row' }}><Text style={{ minWidth: 100 }}>Result PDF </Text><Text>:</Text><TouchableOpacity onPress={() => {
                                try {
                            ...
                            }}><Text style={{ color: 'blue' }}>Download PDF</Text></TouchableOpacity></View> : null}
