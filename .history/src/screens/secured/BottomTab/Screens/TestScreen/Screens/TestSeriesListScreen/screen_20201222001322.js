...
const TestSeriesList = ({
    ...
    return (
        ...
        >
            <View style={{ backgroundColor: 'white', elevation: 5, padding: _scaleText(10).fontSize, flexDirection: 'row', justifyContent: 'space-between' }}><Text style={{ color: COLORS.BLUE_FONT, fontWeight: '500' }} > {_category}</Text>
                {parseInt(_price) ?
