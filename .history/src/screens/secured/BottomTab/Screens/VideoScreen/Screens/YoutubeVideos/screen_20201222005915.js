        ...
        >
            ...
            <FlatList
                ...
                renderItem={({ item, index }) => {
                    ...
                    return (<TouchableOpacity onPress={() => navigation.navigate(ROUTES.VIDEO.SINGLE_VIDEO, { _link: _link, _name: _name })}
                        style={{
                            shadowColor: '#b2b2b2',
