                    ...
                    return (
                        <TouchableOpacity onPress={() => {
                            ...
                            style={{
                                ...
                                shadowOpacity: 0.8,
                                shadowRadius: 1, borderRadius: 10, marginHorizontal: _scaleText(5).fontSize, marginVertical: _scaleText(5).fontSize, padding: _scaleText(20).fontSize, elevation: 5, backgroundColor: COLORS.WHITE
                            }}>
                                <Text>{_name}</Text>
                            </View>
                        </TouchableOpacity>
