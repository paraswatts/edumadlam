...
const FriendsScreen = ({
    ...
    return (
        ...
        >
            <View style={{ backgroundColor: COLORS.PRIMARY.PINK, marginTop: -2, alignItems: 'center', justifyContent: 'center', borderBottomLeftRadius: 300, borderBottomRightRadius: 300 }}>
