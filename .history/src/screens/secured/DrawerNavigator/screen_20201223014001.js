...
const DrawerNavigator = ({
    ...
    return (
        ...
        <Drawer.Navigator lazy initialRouteName={ROUTES.BOTTOM_TAB_DASHBOARD} drawerContent={(props) => <CustomDrawer logoutRequest={logoutRequest}{...props} userData={userData} />} >
