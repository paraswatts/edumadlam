...
let orientationArray = ["LANDSCAPE-LEFT", "LANDSCAPE-RIGHT"];
let orientationArray2 = ["PORTRAIT", "LANDSCAPE-LEFT", "LANDSCAPE-RIGHT"];
          ...
          <Animated.View
            style={[
              styles.container,
              {
                transform: [
                  {
                    rotate: this.state.fullScreen ? spin : spin1
                  }
                ]
              }
            ]}
